...
const characterCount = computed(() => {
  return typeof inputValue.value === 'string' ? inputValue.value.length : 0
})
...
const inputClasses = computed(() => {
  const base = 'block w-full rounded-lg border shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0'
