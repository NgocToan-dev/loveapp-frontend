const vi = {
  ...
  notes: {
    ...
    filterDescription: 'Tìm kiếm và bộ lọc ghi chú của bạn',
    favorites: 'Yêu thích',
    recent: 'Gần đây',
    ...
    saveSuccess: 'Ghi chú đã được lưu thành công!',
    saveError: 'Có lỗi xảy ra khi lưu ghi chú. Vui lòng thử lại.',
    updateSuccess: 'Ghi chú đã được cập nhật thành công!',
    updateError: 'Có lỗi xảy ra khi cập nhật ghi chú. Vui lòng thử lại.',
    save: 'Lưu ghi chú',
    // Category translations
    categoryPersonal: 'Cá nhân',
    categoryWork: 'Công việc',
    categoryLove: 'Tình yêu',
    categoryIdeas: 'Ý tưởng',
    categoryTravel: 'Du lịch',
    categoryHealth: 'Sức khỏe',
    categoryFinance: 'Tài chính',
    categoryOther: 'Khác',    // Form-related keys
    createSubtitle: 'Tạo ghi chú mới để lưu trữ suy nghĩ và cảm xúc của bạn',
    addTag: 'Thêm thẻ tag',
    tagHint: 'Nhấn Enter hoặc dấu phẩy để thêm tag',
    suggestedTags: 'Tag được gợi ý',
    editSubtitle: 'Chỉnh sửa những suy nghĩ và cảm xúc của bạn',
    noteDetail: 'Chi tiết ghi chú',
    noteDetailView: 'Xem chi tiết ghi chú',
    noteDetailDescription: 'Xem thông tin chi tiết về ghi chú cụ thể',
    noteId: 'ID ghi chú',
  },
  reminders: {
  ...
  anniversaries: {
    ...
    updateError: 'Có lỗi xảy ra khi cập nhật ngày kỷ niệm. Vui lòng thử lại.',
    day: 'ngày',
    days: 'ngày',
    anniversary: 'Kỷ niệm',
    statusToday: 'Hôm nay!',
  ...
  common: {
    ...
    noResults: 'Không có kết quả',    recent: 'Gần đây',
