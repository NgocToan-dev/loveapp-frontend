export default {
  title: 'Our Blog',
  subtitle: 'Share thoughts and feelings together',
  ...
  form: {
    ...
    excerpt: 'Excerpt',
    excerptPlaceholder: 'Write a brief summary of your post...',
    excerptHelp: 'A short description that appears in the post list',
